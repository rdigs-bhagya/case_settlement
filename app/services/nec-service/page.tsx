...
const NEC_ServiceSection = () => {
    return (
        <>
                ...
                <div className="container mx-auto px-8 py-4 relative z-10 mt-18">
                    ...
                    <div className="grid lg:grid-cols-2 gap-6 items-center min-h-[500px]">
                        <div className="order-2 lg:order-1 space-y-4">
                            <h1 className="text-4xl lg:text-5xl xl:text-4xl font-extrabold leading-tight">
                              <span className="text-primary">Seeking Justice for NEC-Affected Families</span>
                            </h1>
                    ...
                    <div className="grid lg:grid-cols-2 gap-6 items-center min-h-[450px] ">
                        ...
                        <div className="order-2 lg:order-2 space-y-4">
                            <h1 className="text-4xl lg:text-5xl xl:text-4xl font-extrabold leading-tight">
                                <span className="text-primary">Understanding the Legal Options for NEC Cases</span> 
                            </h1>
                            <div className="space-y-6 text-lg sm:text-lg text-black/90">
                                <p>
                    ...
                    <div className="flex gap-4 pt-2 justify-center items-center">
                        <div className="text-center">
                            <Button
                                size="lg"
                                className="mb-5 bg-blue-900 hover:bg-blue-800 text-white px-8 py-3 text-lg font-bold"
                            >
            ...
            <ServiceProcess mainTitle={afffData.mainTitle} subTitle={afffData.subTitle} steps={afffData.steps} />
...
export default NEC_ServiceSection;